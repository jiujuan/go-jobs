...
// JobLogDAO handles persistence of scheduling records.
type JobLogDAO interface {
	...
	// CreateDetail stores the detailed log text.
...
func (d *jobLogDAO) UpdateResult(ctx context.Context, id int64, status model.LogStatus, errMsg string, start, end time.Time) error {
